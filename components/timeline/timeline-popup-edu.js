...
const TimelineEduPopup = ({ isOpen, onClose, title, organization, date, description, images, videoUrl, techStack, organizationUrl, githubUrl }) => {
...
export default TimelineEduPopup;
